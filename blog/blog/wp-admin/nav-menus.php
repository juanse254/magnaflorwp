				...
				<div class="menu-edit <?php if ( $add_new_screen ) echo 'blank-slate'; ?>">
					...
					<div id="nav-menu-barter">
						<div class="major-publishing-actions wp-clearfix">
							...
							<?php endif; ?>
							<div class="publishing-action">
								<?php submit_button( empty( $nav_menu_selected_id ) ? __( 'Create Menu' ) : __( 'Save Menu' ), 'primary large menu-save', 'save_menu', false, array( 'id' => 'save_menu_barter' ) ); ?>
							</div><!-- END .publishing-action -->
						</div><!-- END .major-publishing-actions -->
					</div><!-- /#nav-menu-barter -->
				</div><!-- /.menu-edit -->
...
<?php include( ABSPATH . 'wp-admin/admin-barter.php' ); ?>
