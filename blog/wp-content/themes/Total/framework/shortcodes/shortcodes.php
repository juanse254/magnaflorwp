...
if ( is_admin() && wpex_get_mod( 'editor_shortcodes_enable', true ) ) {
	...
	function wpex_shortcodes_tinymce_json() {
		...
		<script type='text/javascript'>
			var wpexTinymce = <?php echo wp_json_encode( $data ); ?> ;
		</script>
		<!-- Total TinyMCE Shortcodes -->

	<?php }

	add_action( 'admin_head-post.php', 'wpex_shortcodes_tinymce_json' );
	add_action( 'admin_head-post-new.php', 'wpex_shortcodes_tinymce_json' );
