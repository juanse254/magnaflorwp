 ...
 * @since 4.0.0
 */
class WC_First_Data_Payeezy_API_Transaction_Response extends WC_First_Data_Payeezy_API_Response implements SV_WC_Payment_Gateway_API_Authorization_Response, SV_WC_Payment_Gateway_API_Create_Payment_Token_Response {
	...
	public function get_payment_token() {
		...
		return new SV_WC_Payment_Gateway_Payment_Token( $this->token->token_data->value, array(
			'type'      => 'credit_card',
	...
	public function get_payment_type() {
		...
		return 'WC_First_Data_Payeezy_API_Credit_Card_Transaction_Request' === get_class( $this->get_request() ) ? 'credit-card' : 'echeck';
	}
