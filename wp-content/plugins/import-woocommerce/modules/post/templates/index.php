...
<!-- End Terms and Taxonomy -->
		<?php
                        $csvsettings = get_option('woocomcsvfreesettings');
...
?>
		...
		<input type='button' id='clear_mapping' class='clear_mapping btn btn-warning' name='clear_mapping' title = '<?php echo esc_attr__("Reset",'import-woocommerce'); ?>' value='<?php echo esc_attr__("Reset","import-woocmmerce"); ?>' onclick='clearMapping();' style = 'float:left'/>
		</div>
		...
		<tr>
		<td>
		<h3><?php echo esc_attr__('Settings and Performance','import-woocommerce'); ?></h3>
