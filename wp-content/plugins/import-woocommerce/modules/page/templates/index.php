...
?>
	...
	<!-- The global progress bar -->
        <div class="form-group" style="padding-bottom:20px;">
                                ...
                                <input type='button' name='clearform' id='clearform' value='<?php echo esc_attr__("Clear",'import-woocommerce'); ?>' onclick="Reload();"
                                class='btn btn-warning' style="margin-right:15px"/>
                                <input type='submit' name='importfile' id='importfile' title = '<?php echo esc_attr__("Next",'import-woocommerce'); ?>' value='<?php echo esc_attr__("Next",'import-woocommerce'); echo esc_attr__(" >>");?>' disabled
	...
	?>
	<h3><?php echo esc_html__('Map CSV to WP fields/attributes','import-woocommerce'); ?></h3>
	...
	<h2><div class="secondformheader"><?php echo esc_html__('Import Data Configuration','import-woocommerce'); ?></div></h2>
        <?php  
...
?>
		...
		<div>
                ...
                <input type='button' id='clear_mapping' title = '<?php echo esc_attr__("Reset",'import-woocommerce'); ?>' class='clear_mapping btn btn-warning' name='clear_mapping' value='<?php echo esc_attr__('Reset','import-woocommerce');?>' onclick='clearMapping();' style = 'float:left'/>
                <span style = ''>
                <a href="#" class="tooltip tooltip_smack"  style = ''>
                <img src="<?php echo esc_url(Woocom_CONST_CSV_IMP_DIR.'images/help.png');?>" />
                <span class="tooltipClearMapping">
                <img class="callout" src="<?php echo esc_url(Woocom_CONST_CSV_IMP_DIR.'images/callout.gif');?>" />
                <strong><?php echo esc_html__('Refresh to re-map fields','import-woocommerce'); ?></strong>
                <img src="<?php echo esc_url(Woocom_CONST_CSV_IMP_DIR.'images/help.png');?>" style="margin-top: 6px;float:right;" />
                </span>
                </a>
                </span>
                </div>
...
<input type='hidden' name='wpnoncekey' id='wpnoncekey' value='<?php echo $nonce_Key; ?>' />
		<label id="importalign"><input name='duplicatetitle' id='duplicatetitle' type="checkbox" value="" > <?php echo esc_html__('Detect duplicate post title','import-woocommerce'); ?></label> <br>
		 <label id="importalign"><?php echo esc_html__('No. of posts/rows per server request','import-woocommerce'); ?></label> <span class="mandatory" style="margin-left:-13px;margin-right:10px">*</span> <input name="importlimit" id="importlimit" type="text" value="1" placeholder="10" onblur="check_allnumeric(this.value);"></label> <?php echo $impCE->helpnotes(); ?> <br>
			<span class='msg' id='server_request_warning' style="display:none;color:red;margin-left:-10px;"><?php echo esc_html__('You can set upto ','import-woocommerce'); ?><?php echo sanitize_text_field($_SESSION['SMACK_MAPPING_SETTINGS_VALUES']['totRecords']); ?> <?php echo esc_html__('per request.','import-woocommerce'); ?></span>
		...
		<input id="startbutton" class="btn btn-primary" type="button" value="<?php echo esc_attr__('Import Now','import-woocommerce'); ?>" style="color: #ffffff;background:#2E9AFE;" onclick="importRecordsbySettings();" >
