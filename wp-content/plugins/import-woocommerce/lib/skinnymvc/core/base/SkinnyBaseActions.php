...
class SkinnyBaseActions {
   ...
   */
   public function call($module='default', $action='index', $request=array('GET'=>array(), 'POST'=>array())) {
      $moduleClass = SkinnyControllerWoocomCsvFree::camelize($module) . 'Actions';

      $actionMethod = 'execute'.SkinnyControllerWoocomCsvFree::camelize($action);
   ...
   */
   ...
   {
     SkinnyBaseControllerWoocomCsvFree::setLayout($layout);
   }
