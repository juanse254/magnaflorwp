...
class SkinnyBaseControllerWoocomCsvFree {
   ...
   */
    public function main()
    {
           ...
           // Slash after the module missing?
            ...
            if (  $hasMissingSlash  ) {
                ...
                if (  $this->allowModulesAsFiles   ) {
                    ...
                    echo file_get_contents(Woocom_CSVIMP_PLUGIN_BASE."templates/404.php");
                    exit;
                }
            }
        ...
        $this->require_once_many(Woocom_CSVIMP_PLUGIN_BASE."lib/skinnymvc/core/base/*.php");
        $this->require_once_many(Woocom_CSVIMP_PLUGIN_BASE."lib/skinnymvc/core/*.php");

        // Get the db controller classes
        $this->require_once_many(Woocom_CSVIMP_PLUGIN_BASE."lib/skinnymvc/dbcontroller/base/*.php");
        $this->require_once_many(Woocom_CSVIMP_PLUGIN_BASE."lib/skinnymvc/dbcontroller/*.php");

        // Get the controller classes
        $this->require_once_many(Woocom_CSVIMP_PLUGIN_BASE."lib/skinnymvc/controller/base/*.php");
        $this->require_once_many(Woocom_CSVIMP_PLUGIN_BASE."lib/skinnymvc/controller/*.php");
        ...
        //Get all plugins
        $this->require_once_many(Woocom_CSVIMP_PLUGIN_BASE."plugins/skinnyPlugin*.php");
    ...
    protected function executeModuleAction($module, $action, $param)
    {
        ...
        if (!file_exists(Woocom_CSVIMP_PLUGIN_BASE."modules/$module/actions/actions.php")) {
            //Error: Action does not exist
            header("HTTP/1.1 404 Not Found");
            echo file_get_contents(Woocom_CSVIMP_PLUGIN_BASE."templates/404.php");
            exit;
        ...
        require_once(Woocom_CSVIMP_PLUGIN_BASE."modules/$module/actions/actions.php");
        ...
        if ( $moduleObj->allowUndefinedActions()) {
            ...
            if (  is_callable(array($moduleObj, $actionMethod))  ) {
                ...
                if (!file_exists(Woocom_CSVIMP_PLUGIN_BASE."modules/$module/templates/$action.php")) {
                    //Error: Action does not exist
                    header("HTTP/1.1 404 Not Found");
                    echo file_get_contents(Woocom_CSVIMP_PLUGIN_BASE."templates/404.php");
                    exit;
        ...
        $actionTemplateSource = file_get_contents(Woocom_CSVIMP_PLUGIN_BASE."modules/$module/templates/$action.php");
   ...
   */
   ...
   private function processLayout(&$skinny_content, $layoutData, $skinnyUser, $module, $action, $layout) {
      include_once Woocom_CSVIMP_PLUGIN_BASE.'templates/'. $layout .'.php';
   }
   ...
   private function require_once_many($pattern)
   {
    ...
    {
        return file_exists(Woocom_CSVIMP_PLUGIN_BASE.'modules/'. $moduleName .'/actions/actions.php');
    }

    protected function actionExists($moduleName, $actionName)
    {
        return file_exists(Woocom_CSVIMP_PLUGIN_BASE.'modules/'. $moduleName .'/templates/'. $actionName .'.php');
    }
