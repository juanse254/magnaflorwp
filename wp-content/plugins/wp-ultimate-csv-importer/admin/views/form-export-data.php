...
if($exportType) :
	...
	<div style="width: 98%;" class="template_body whole_body wp_ultimate_csv_importer_pro">
		<form name="export_filters" id="export_filters" method="post" action="<?php #echo admin_url('admin-ajax.php'); ?>" >
			...
			?>
			<p>
				<label class="media_styles"><input type='checkbox'  name='getdataforspecificperiod' id='getdataforspecificperiod' value='getdataforspecificperiod' onclick='addexportfilter(this.id);' <?php echo $disabled ?> /><span id="align"> <?php echo esc_html__('Export data for the specific period','wp-ultimate-csv-importer');?></span></label>
			...
			<?php if($exportType !== 'users' && $exportType !== 'categories' && $exportType !== 'tags' && $exportType !== 'customtaxonomy' && $exportType !== 'customerreviews' && $exportType !== 'comments') { ?>
				<p>
					...
					<input type='checkbox'  name='getdatawithspecificstatus' id='getdatawithspecificstatus' value='getdatawithspecificstatus' onclick='addexportfilter(this.id);' <?php echo $disabled ?> /><span id="align"> <?php echo esc_html__('Export data with the specific status','wp-ultimate-csv-importer');?></span></label>
			...
			<?php if($exportType !== 'users' && $exportType !== 'categories' && $exportType !== 'tags' && $exportType !== 'customtaxonomy' && $exportType !== 'customerreviews') { ?>
				<p>
					<label class="media_styles"><input  type='checkbox' name='getdatabyspecificauthors' id='getdatabyspecificauthors' value='getdatabyspecificauthors' onclick='addexportfilter(this.id);' <?php echo $disabled ?>/><span id="align"> <?php echo esc_html__('Export data by specific authors','wp-ultimate-csv-importer');?></span></label>
