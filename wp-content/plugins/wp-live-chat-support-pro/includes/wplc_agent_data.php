...
add_filter("wplc_filter_further_live_chat_box_above_main_div","wplc_pro_filter_control_live_chat_box_above_main_div",10,4);
function wplc_pro_filter_control_live_chat_box_above_main_div( $msg, $wplc_settings, $cid, $chat_data ) {
