...
class MaxGalleriaMediaLib {
  ...
  public function __construct() {
	...
	public function set_global_constants() {	
		...
		define('MAXGALLERIA_MEDIA_LIBRARY_VERSION_NUM', '3.3.5');
...
and pm.meta_key = '_wp_attached_file'";
  ...
  public function setup_mg_media_plus() {
    add_menu_page(__('Media Library Folders','maxgalleria-media-library'), __('Media Library Folders','maxgalleria-media-library'), 'upload_files', 'media-library', array($this, 'media_library'), 'dashicons-admin-media', 11 );				
    ...
    add_submenu_page('media-library', __('Check For New Folders','maxgalleria-media-library'), __('Check For New Folders','maxgalleria-media-library'), 'upload_files', 'admin-check-for-new-folders', array($this, 'admin_check_for_new_folders'));
...
//    echo '  <div class="media-plus-toolbar wp-filter"><div class="media-toolbar-secondary">' . PHP_EOL;
    ...
    echo '  <div>' . PHP_EOL;
    echo '  <span id="back-wraper"><a href="' . site_url() . '/wp-admin/admin.php?page=media-library">Back to Media Library Folders Folders</a></span>' . PHP_EOL;
...
and meta_key = '_wp_attached_file';";
			...
			$location = 'window.location.href = "' . site_url() . '/wp-admin/admin.php?page=media-library&media-folder=' . $parent_folder .'";';
